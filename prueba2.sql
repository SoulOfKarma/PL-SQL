...
ON(p.NRO_PROPIEDAD=arr.NRO_PROPIEDAD)
WHERE p.NUMRUT_EMP=NROPRO 
AND ((arr.FECINI_ARRIENDO < to_date('01/05/2016','dd/mm/yyyy')
 and nvl(arr.FECTER_ARRIENDO,to_date('01/06/3016','dd/mm/yyyy'))
